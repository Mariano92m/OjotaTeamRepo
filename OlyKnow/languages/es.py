...
'includes': 'incluye',
'Index': 'Índice',
'Ingrese el costo del evento, por favor.': 'Ingrese el costo del evento, por favor.',
'Ingrese el organizador del evento, por favor.': 'Ingrese el organizador del evento, por favor.',
'Ingrese su nombre, por favor.': 'Ingrese su nombre, por favor.',
'Ingrese una categoria que corresponde al evento, por favor.': 'Ingrese una categoria que corresponde al evento, por favor.',
'Ingrese una descripción del evento, por favor.': 'Ingrese una descripción del evento, por favor.',
